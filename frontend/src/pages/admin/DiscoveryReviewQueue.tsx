...
function batchLabel(batchId: unknown) {
  if (batchId === "milestone-4c-new-plants") return "new twelve"
  if (batchId === "milestone-4c-final-eight") return "final eight"
  return "original ten"
}
