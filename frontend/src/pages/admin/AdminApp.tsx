...
function Dashboard() {
  return <><PageHeader eyebrow="Operations / overview" title="Dashboard" description="This workspace is reserved for the scheduled collection, orchestration, and agent operations planned for the next approved milestone." /><AdminStateCard eyebrow="Future operations" title="No operational dashboard yet" description="Static encyclopedia review is available in Plants Review. Live collection health, schedules, agent activity, and orchestration metrics will appear here only after those systems are implemented." action={<Link to="/admin/reviews" className="inline-flex items-center gap-2 bg-forest px-4 py-3 font-sans text-xs font-bold uppercase tracking-[.1em] text-cream">Open Plants Review</Link>} /></>
}
